...
MODEL                = Defrost_3
MODULES              = rt_logging.c Defrost_3.c Defrost_3_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c rt_sim.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Defrost_3.exe
MAKEFILE             = Defrost_3.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2022b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2022b
START_DIR            = C:/Users/muham/Desktop/MST_IESE_2023/M2_S1/Traitement_Num_Image/TNI_TP
S_FUNCTIONS_LIB      = 
NUMST                = 3
NCSTATES             = 0
BUILDARGS            =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="C:\\Program Files\\MATLAB\\R2022b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DRT -DRSIM_PARAMETER_LOADING -DTID01EQ=1"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
SYSTEM_LIBS             = -L"C:\Program Files\MATLAB\R2022b\extern\lib\win64\microsoft" libmat.lib libmx.lib libut.lib libmwsl_fileio.lib libmwsl_simtarget_instrumentation.lib libmwi18n.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib sf_runtime.lib
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 0

#--------------------------- Model and reference models -----------------------
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Defrost_3_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/Defrost_3_rsim_rtw \
